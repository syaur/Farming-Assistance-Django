...
from .views import signup,check_user_exists,loginView,index,validate_username
from django.contrib.auth import views
from farmer import views as f_views
...
urlpatterns = [
    ...
    path('advertisement/', f_views.showad , name = 'showad'),
